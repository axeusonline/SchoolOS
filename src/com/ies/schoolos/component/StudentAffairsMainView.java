...
import com.ies.schoolos.component.studentaffairs.StudentBehaviorView;
...
public class StudentAffairsMainView extends VerticalLayout {
	...
	private void buildMainLayout(){
		...
		Button studentBehavior = new Button("1.คะแนนพฤติกรรม", FontAwesome.CUBE);
		studentBehavior.setSizeFull();
		dashboar.addComponent(studentBehavior);
		addClickListener(studentBehavior, StudentBehaviorView.class);
		...
		initTab(new StudentBehaviorView(), studentBehavior.getCaption());
		addedTab.add(studentBehavior.getCaption());
